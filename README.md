*Тестовое задание про картинки*

Собиралось в Xcode 26.0.1 для iOS версий от 16.0 до более поздних (26.0 на момент публикации)



*Собственно задание:*

Дано: Текстовый файлик со ссылками на картинки.
...
Грид с превьюшками картинок (уменьшёнными до приемлемых размеров, не оригиналами). На местах не-картинок и не-ссылок нужны заглушки. 
По нажатию на превьюшку — оригинал картинки целиком.


При  выполнении тестового задания нельзя  использовать готовые библиотеки для ui, сетевых запросов и кэширования (например, Alomofire, Kingfisher и тд). 
Все сетевые запросы, ретраи, кэширование необходимо написать самостоятельно. 
Можно использовать стандартные инструменты для логики Foundation: NSCashe, FileManager, URLSession и тд. Для ui UIKit или SwiftUI
...
Автоматически выкачивать файл с сервера, после запуска приложения. После скачивания файл можно кэшировать на диске в приватном каталоге приложения. Не сохранять файл в сам проект. 
...
Кэшировать оригиналы картинок и превьюшки на диск. При повторном открытии картинки и при повторном запуске приложения ранее сохранённые превьюшки и оригиналы картинок следует загружать с диска. 
